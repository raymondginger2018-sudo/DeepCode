...
TOOLS = {
    ...
    "cerebellum_memory_forget": {
        "description": "删除一条记忆 — 同步清理语义索引",
        "inputSchema": {
            "type": "object",
            "properties": {"key": {"type": "string"}},
        },
    ...
    "cerebellum_memory_stats": {
        "description": "记忆系统统计 — 各后端状态 + 小脑语义层计数",
        "inputSchema": {"type": "object", "properties": {}},
    },
    ...
    "cerebellum_skill_lineage_history": {
        "description": "查看 Skill 版本血缘 (E3, OpenSpace SkillLineage) — generation/lineage/trust/hash/提案号",
        "inputSchema": {
            "type": "object",
            "properties": {
                "skill_name": {"type": "string"},
    ...
    "cerebellum_skill_version_diff": {
        "description": "Skill 两个版本的 content 快照 diff (E3) — 行级 unified diff",
        "inputSchema": {
            "type": "object",
            "properties": {
                "skill_name": {"type": "string"},
        ...
        "required": ["skill_name", "from_generation", "to_generation"],
    },
...
MCP_SLEEP_POOL = {
    ...
    "filesystem": {
        "command": "npx",
        "args": ["-y", "@modelcontextprotocol/server-filesystem", "F:/DEEPCODE/core"],
        "env": {},
        "description": "文件系统访问: 读写/搜索文件 (MCP 官方)",
        "tool_prefix": "",
    },
    "sqlite": {
        "command": "npx",
        "args": ["-y", "mcp-server-sqlite", "--db", "F:/DEEPCODE/core/data.db"],
        "env": {},
        "description": "SQLite 数据库: SQL 查询/表管理",
        "tool_prefix": "",
    },
    "duckdb": {
        "command": "npx",
        "args": ["-y", "mcp-duckdb-local", "--db-path", ":memory:", "--read-write"],
        "env": {},
        "description": "DuckDB 数据库: 内存分析/CSV 查询",
        "tool_prefix": "",
    },
    "postgres": {
        "command": "npx",
        "args": ["-y", "@modelcontextprotocol/server-postgres", "postgresql://postgres:postgres@localhost:5432/claude_analytics"],
        "env": {},
        "description": "PostgreSQL 数据库 (需本地 pg 在 5432 端口运行)",
        "tool_prefix": "",
    },
    "github": {
        "command": "npx",
        ...
        "description": "GitHub API: PR/Issue/代码搜索/仓库管理",
        "tool_prefix": "",
    },
    "deveco-mcp": {
        "command": "devecocli",
        "args": ["serve", "mcp"],
        "env": {"PROJECT_PATH": "F:/DEEPCODE/core"},
        "description": "鸿蒙 DevEco 开发: 鸿蒙应用开发工具链",
        "tool_prefix": "",
    },
    "harmonyos": {
        "command": "npx",
    ...
    "harmonyos-best-practices": {
        ...
        "env": {},
        "description": "鸿蒙最佳实践: 鸿蒙应用开发最佳实践指南",
        "tool_prefix": "",
    },
    "hometrans": {
        "command": "ht",
        "args": ["mcp"],
        "env": {},
        "description": "HomeTrans 家庭翻译: 多语言翻译服务",
        "tool_prefix": "",
    },
    "office-pro": {
        "command": "npx",
        "args": ["-y", "office-mcp"],
        "env": {},
        "description": "Office 办公: 文档/表格/PPT 处理",
        "tool_prefix": "",
    },
    "notion": {
        "command": "npx",
        ...
        "env": {},
        "description": "Notion 笔记: 页面/数据库/块操作",
        "tool_prefix": "",
    },
    "autocad": {
        "command": "uv",
        "args": ["--directory", "C:/Users/raymo/multiCAD-mcp", "run", "python", "src/server.py"],
        "env": {},
        "description": "AutoCAD 设计: CAD 图纸操作/自动化设计",
        "tool_prefix": "",
    },
    "deepcode-engine": {
        "command": "python",
        "args": ["F:/DEEPCODE/deepcode-engine-mcp/mcp_servers/deepcode_engine_server.py"],
        "env": {"TELEMETRY": "true"},
        "description": "DeepCode 核心引擎精简版: 只保留 unique 功能 (并行执行/检查点/事件总线/工具注册/系统监控, 16 工具)",
        "tool_prefix": "",
    },
}
...
def _call(name: str, args: dict) -> dict:
    ...
    if name == "cerebellum_memory_forget":
        return CerebellumMemory().forget(args["key"])
    if name == "cerebellum_memory_stats":
        return CerebellumMemory().stats()
    ...
    if name == "cerebellum_skill_lineage_history":
        return skill_lineage_history(args["skill_name"], limit=args.get("limit", 50))
    if name == "cerebellum_skill_version_diff":
        return skill_version_diff(args["skill_name"], args["from_generation"], args["to_generation"])
