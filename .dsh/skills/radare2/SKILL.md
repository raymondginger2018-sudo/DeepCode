...
name: radare2
description: >
  当用户想用命令行 radare2/r2 分析二进制时使用，覆盖逆向、反汇编、函数分析、字符串/导入检查、补丁、二进制比对、hex 检查、r2 脚本；当用户提到 PE/ELF/Mach-O/DEX/WASM 文件配合 CLI 分析、rabin2、rasm2、radiff2、r2pipe，或询问 Windows/Linux/macOS 上的 radare2 命令帮助时也使用。
version: 1.0.0
